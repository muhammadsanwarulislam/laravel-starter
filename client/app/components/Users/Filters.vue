      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="lg:col-span-2">
          <div class="relative">
            ...
            <input v-model="search" @input="$emit('search', search)" type="text"
        ...
        <!-- Status Filter -->
        <div>
          <select v-model="status" @change="$emit('filter', { status })"
        ...
        <!-- Role Filter -->
        <div>
          <select v-model="role" @change="$emit('filter', { role })" :disabled="loadingRoles"
