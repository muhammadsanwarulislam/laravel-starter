  ...
  <tr :class="rowClasses">
    ...
    <td class="px-6 py-4 whitespace-nowrap">
      <div class="flex flex-wrap gap-1.5">
        <UIBadge v-for="role in user.roles" :key="role.id" :variant="getRoleVariant(role.slug)"
    ...
    <!-- Status -->
    <td class="px-6 py-4 whitespace-nowrap">
      <UIBadge :variant="user.status ? 'success' : 'danger'" :outlined="!user.status" class="font-medium">
        <template #icon>
    ...
    <td class="px-6 py-4 whitespace-nowrap">
      <div class="flex items-center gap-2">
        <UIButton variant="secondary" size="sm" outlined @click="$emit('view')" title="View Details"
        ...
        <UIButton variant="warning" size="sm" outlined @click="$emit('edit')" title="Edit User" class="hover:shadow-md">
          <template #icon>
        ...
        <UIButton variant="danger" size="sm" outlined @click="$emit('delete')" title="Delete User"
          class="hover:shadow-md">
          <template #icon>
