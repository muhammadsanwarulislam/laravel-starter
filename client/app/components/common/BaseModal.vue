<!-- components/common/TransparentModal.vue -->
<template>
  <transition
  ...
  >
    ...
    >
      ...
      <div 
        class="fixed inset-0 bg-white/40 backdrop-blur-sm transition-opacity"
        :class="backdropClass"
        aria-hidden="true"
      ...
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        >
          ...
          >
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        class="text-gray-300 mt-1 text-sm"
                      >
                        {{ description }}
                      </p>
                    </div>
            ...
            <!-- Decorative Elements -->
            <div class="absolute top-0 left-0 w-32 h-32 bg-blue-500/10 rounded-full -translate-x-1/2 -translate-y-1/2 blur-xl"></div>
            <div class="absolute bottom-0 right-0 w-40 h-40 bg-purple-500/10 rounded-full translate-x-1/2 translate-y-1/2 blur-xl"></div>
          </div>
        </transition>
      </div>
    </div>
