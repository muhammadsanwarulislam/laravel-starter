<template>
  <div class="min-h-screen flex">
          ...
          <form @submit.prevent="handleSubmit" class="mt-4 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
              ...
              <div class="col-span-full">
                ...
                <p
                  v-else-if="
                    form.name.trim() && /^[A-Za-z]/.test(form.name.trim())
                  "
                ...
                <div class="flex gap-2">
                  ...
                  <div class="relative flex-1 max-w-xs">
                    ...
                    <select
                      ...
                      :class="[
                        'block w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 appearance-none',
    ...
    <div
      class="hidden lg:flex lg:w-1/2 bg-linear-to-br from-green-500 via-emerald-500 to-teal-500 p-12"
    >
      <div class="flex flex-col justify-between h-full">
        ...
        <div class="grid grid-cols-4 gap-3 mt-8">
          <div
            v-for="n in 8"
            :key="n"
            class="h-2 rounded-full bg-white/30"
            :class="{ 'bg-white/60': n % 3 === 0 }"
          ></div>
        </div>
      </div>
    </div>
...
const validateForm = (): boolean => {
  ...
  if (!form.name.trim()) {
    ...
    errors.name =
      "Name must start with a letter and can contain letters, numbers, hyphens, underscores, or spaces";
    isValid = false;
