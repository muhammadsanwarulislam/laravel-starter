...
class LanguageSeeder extends Seeder
{
    ...
    private function createInitialTranslations(): void
    {
        $translations = [
            ...
            'language_info' => ['en' => 'Select your preferred language', 'bn' => 'আপনার পছন্দের ভাষা নির্বাচন করুন','hi' => 'अपनी पसंदीदा भाषा चुनें','fa' => 'زبان مورد علاقه خود را انتخاب کنید','ar' => 'اختر لغتك المفضلة','ur' => 'اپنی پسندیدہ زبان منتخب کریں','zh' => '选择您喜欢的语言','ko' => '전환 언어를 설정 하세요','ja' => 'お好みの言語を選択してください','de' => 'Wählen Sie Ihre bevorzugte Sprache', 'es' => 'Seleccione su idioma preferido', 'fr' => 'Sélectionnez votre langue préférée'],
            'select_language' => ['en' => 'Select Language', 'bn' => 'ভাষা নির্বাচন করুন','hi' => 'भाषा चुनें','fa' => 'انتخاب زبان','ar' => 'اختر اللغة','ur' => 'زبان منتخب کریں','zh' => '选择语言','ko' => '언어 설정','ja' => '言語を選択','de' => 'Sprache auswählen', 'es' => 'Seleccionar idioma', 'fr' => 'Choisir la langue'],
            'current_translations' => ['en' => 'Current Translations', 'bn' => 'বর্তমান অনুবাদ','hi' => 'वर्तमान अनुवाद','fa' => 'ترجمه‌های فعلی','ar' => 'الترجمات الحالية','ur' => 'موجودہ تراجم','zh' => '当前翻译','ko' => '현재 인역','ja' => '現在の翻訳','de' => 'Aktuelle Übersetzungen', 'es' => 'Traducciones actuales', 'fr' => 'Traductions actuelles'],
            'translation_key' => ['en' => 'Translation Key', 'bn' => 'অনুবাদ কী','hi' => 'अनुवाद कुंजी','fa' => 'کلید ترجمه','ar' => 'مفتاح الترجمة','ur' => 'ترجمہ کلید','zh' => '翻译键','ko' => '인역 키','ja' => '翻訳キー','de' => 'Übersetzungsschlüssel', 'es' => 'Clave de traducción', 'fr' => 'Clé de traduction'],
            'language_code' => ['en' => 'Language Code', 'bn' => 'ভাষার কোড','hi' => 'भाषा कोड','fa' => 'کد زبان','ar' => 'رمز اللغة','ur' => 'زبان کوڈ','zh' => '语言代码','ko' => '언어 코드','ja' => '言語コード','de' => 'Sprachcode', 'es' => 'Código de idioma', 'fr' => 'Code de langue'],
            'language_name' => ['en' => 'Language Name', 'bn' => 'ভাষার নাম','hi' => 'भाषा का नाम','fa' => 'نام زبان','ar' => 'اسم اللغة','ur' => 'زبان کا نام','zh' => '语言名称','ko' => '언어 이름','ja' => '言語名','de' => 'Sprachname', 'es' => 'Nombre del idioma', 'fr' => 'Nom de la langue'],
            'translation_count' => ['en' => 'Translation Count', 'bn' => 'অনুবাদের সংখ্যা','hi' => 'अनुवाद गणना','fa' => 'شمارش ترجمه','ar' => 'عدد الترجمات','ur' => 'ترجمہ گنتی','zh' => '翻译计数','ko' => '인역 수자','ja' => '翻訳数','de' => 'Übersetzungsanzahl', 'es' => 'Recuento de traducciones', 'fr' => 'Nombre de traductions'],
            'key' => ['en' => 'Key', 'bn' => 'কী','hi' => 'कुंजी','fa' => 'کلید','ar' => 'مفتاح','ur' => 'کلید','zh' => '键','ko' => '키','ja' => 'キー','de' => 'Schlüssel', 'es' => 'Clave', 'fr' => 'Clé'],
            'value' => ['en' => 'Value', 'bn' => 'মান','hi' => 'मूल्य','fa' => 'مقدار','ar' => 'قيمة','ur' => 'قدر','zh' => '值','ko' => '값','ja' => '値','de' => 'Wert', 'es' => 'Valor', 'fr' => 'Valeur'],
        ];
